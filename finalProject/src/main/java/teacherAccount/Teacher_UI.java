...
import accountFactory.TeacherInterface;
...
public class Teacher_UI extends JFrame implements TeacherInterface{
	...
	public Teacher_UI(SignIn_Window signin, MainMenu mainmenu) {
		...
		studentList.setBounds(10, 35, 138, 47);
	...
	private void deleteDataSQL() throws ClassNotFoundException {
        ...
        numCheckBox = 0;
        teacherOwnClass.removeAll(deleteList);
        deleteList.clear();
	}
	...
	public boolean checkDuplicateClass(String name) {
